<html>
    <body>
        <p>
            ...
            You can mark an object as public and get it's public URL by calling <a href="<?= $app->getUrl('/documentation/api/app.data.getfilename/') ?>">$app->data->getFilename</a> and passing it to <a href="<?= $app->getUrl('/documentation/api/app.assets.geturl/') ?>">$app->assets->getUrl</a>.
        </p>
        <h2>API</h2>
